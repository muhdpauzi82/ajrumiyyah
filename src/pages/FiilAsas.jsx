...
export default function FiilAsas() {
 ...
 const [questions] = useState(() => shuffle(fiilAsas).slice(0, 10));
  ...
  setTimeout(() => {
    ...
    if (current < questions.length - 1) {
      ...
      if (wrongCount === 0 && betul) {
        localStorage.setItem("fiilAsasDone", "true");
        alert("🏡 Tahap Asas selesai! Akademi Fiil terbuka.");
        navigate("/jejak-fiil");
      } else {
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        <h1 style={styles.title}>📖 Tahap Asas Fi'il</h1>
