...
export default function MenaraFiil() {
  ...
  const [questions] = useState(() => shuffle(fiilMenara).slice(0, 10));
  ...
  setTimeout(() => {
    ...
    if (current < questions.length - 1) {
      ...
      if (wrongCount === 0 && betul) {
        localStorage.setItem("fiilMenaraDone", "true");
        alert("🗼 Menara Bina' Fi'il selesai! Sarjana Fi'il terbuka.");
        navigate("/jejak-fiil");
      } else {
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        <div style={styles.badge}>🗼 Menara Bina' Fi'il</div>

        <h1 style={styles.title}>🗼 Menara Bina' Fi'il</h1>
