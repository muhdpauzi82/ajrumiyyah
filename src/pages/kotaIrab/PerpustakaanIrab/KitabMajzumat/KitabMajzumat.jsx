...
import "./KitabMajzumat.css";
import { majzumPages } from "./majzumPages";

const BASE_WIDTH = 1200;
const BASE_HEIGHT = 700;

export default function KitabMajzumat() {
  ...
  const page = majzumPages[pageIndex];
  ...
  const isLastPage =
  pageIndex === majzumPages.length - 1;
 ...
 function finishBook() {
  ...
  return (
    ...
    >
      <main
        className="kitab-majzum-screen"
        style={{
          transform: `scale(${scale})`,
        }}
      >
        <section className="kitab-majzum-book">
...
>
  {page.matan}
            ...
            {page.type === "matan" &&
              page.signs && (
                <ul className="kitab-matan-signs majzum-matan-signs">
                  {page.signs.map(
                    (sign, index) => (
                      <li
                        key={`${sign}-${index}`}
  ...
  <div className="kitab-complete-content">
    ...
    <button
      ...
      onClick={() => navigate("/latihan-majzumat")}
    >
      ...
      <span className="training-hotspot-text">
        <strong>LATIHAN MAJZUMAT</strong>
