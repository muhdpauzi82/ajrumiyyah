...
import "./KitabMajrurat.css";
import { majrurPages } from "./majrurPages";

const BASE_WIDTH = 1200;
const BASE_HEIGHT = 700;

export default function KitabMajrurat() {
  ...
  const page = majrurPages[pageIndex];
  ...
  const isLastPage =
    pageIndex === majrurPages.length - 1;
  ...
  return (
    ...
    >
      <main
        className="kitab-majrur-screen"
        style={{
          transform: `scale(${scale})`,
        }}
      >
        <section className="kitab-majrur-book">
 ...
 {/* RINGKASAN */}
  ...
  <div className="kitab-complete-content">
    ...
    <button
      ...
      onClick={() => navigate("/latihan-majrurat")}
    >
      ...
      <span className="training-hotspot-text">
        <strong>LATIHAN MAJRURAT</strong>
