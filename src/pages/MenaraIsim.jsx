...
export default function MenaraIsim() {
 ...
 const [questions] = useState(() => shuffle(menaraIsim).slice(0, 10));
...
alert("🎓 Menara Isim selesai! Sarjana Isim terbuka.");
navigate("/jejak-isim");
      } else {
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        <div style={styles.badge}>🎓 Menara Isim</div>

        <h1 style={styles.title}>🎓 Tahap Lanjutan Isim</h1>
