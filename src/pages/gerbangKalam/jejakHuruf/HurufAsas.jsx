...
import { hurufAsas } from "../../../data/hurufQuestions";
...
export default function HurufAsas() {
 
  const [questions] = useState(() => shuffle(hurufAsas).slice(0, 10));
  ...
  setTimeout(() => {
    ...
    if (current < questions.length - 1) {
      ...
      if (wrongCount === 0 && betul) {
         localStorage.setItem("hurufAsasDone", "true");
         alert("🏕️ Kem Huruf selesai! Akademi Huruf terbuka.");
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        <div style={styles.badge}>🏕️ Kem Huruf</div>
        <h1 style={styles.title}>📖 Tahap Asas Huruf</h1>
...
const styles = {
  page: {
    minHeight: "100vh",
    background:
      "linear-gradient(to bottom, rgba(126,195,90,.9), rgba(67,124,48,.95)), url('/images/hurufbg.webp')",
