...
export default function HurufAsas() {
  ...
  function tamatLatihan(finalWrongCount) {
    if (finalWrongCount === 0) {
      ...
      setFeedback({
        type: "complete",
        title: "Kampung Huruf Selesai!",
        message:
          "Tahniah! Anda menjawab semua soalan dengan betul. Akademi Huruf kini telah dibuka.",
      });
    ...
    setFeedback({
      ...
      message:
        ...
        "Ulang latihan Kampung Huruf untuk membuka Akademi Huruf.",
    });
  }
    ...
    return (
      <main className="huruf-quiz-screen">
        <div className="huruf-empty-state">
          Soalan Huruf Asas tidak ditemui.
        </div>
      </main>
    );
  }
        ...
        <section className="huruf-quiz-card">
          <header className="huruf-quiz-header">
            ...
            <p className="huruf-quiz-subtitle">
              Kenali jenis huruf dan fungsi asasnya
              dalam ayat.
            </p>
          </header>
