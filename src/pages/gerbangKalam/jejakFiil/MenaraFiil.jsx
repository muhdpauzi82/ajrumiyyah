...
import "./MenaraFiil.css";
import { fiilMenara } from "../../../data/fiilQuestions";
...
export default function MenaraFiil() {
  const navigate = useNavigate();
  const timeoutRef = useRef(null);

  const questions = useMemo(
    () => prepareQuestions(fiilMenara),
    []
  );
  ...
  function tamatLatihan(finalWrongCount) {
    if (finalWrongCount === 0) {
      ...
      setFeedback({
        type: "complete",
        title: "Menara Fi‘il Selesai!",
        message:
          "Tahniah! Anda berjaya menamatkan tahap lanjutan. Sarjana Fi‘il kini telah dibuka.",
      });
    ...
    setFeedback({
      ...
      message:
        ...
        "Ulang Menara Fi‘il untuk membuka Sarjana Fi‘il.",
    });
  }
    ...
    if (isCorrect) {
      ...
      setFeedback({
        ...
        message:
          ...
          "Teliti semula binaan dan jenis fi‘il.",
      });
    }
    ...
    return (
      <main className="fiil-quiz-screen">
        <div className="fiil-empty-state">
          Soalan Menara Fi‘il tidak ditemui.
        </div>
      </main>
    );
  }
        ...
        <section className="fiil-quiz-card">
          <header className="fiil-quiz-header">
            <div className="fiil-location-badge">
              ...
              <span>Menara Fi‘il</span>
            </div>

            <h1 className="fiil-quiz-title">
              Tahap Lanjutan Fi‘il
            </h1>

            <p className="fiil-quiz-subtitle">
              Uji kefahaman tentang binaan dan
              penggunaan fi‘il.
            </p>
          </header>
